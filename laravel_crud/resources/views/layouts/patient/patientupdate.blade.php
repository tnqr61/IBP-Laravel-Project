              ...
              <div class="card-body p-5">
                ...
                <form action="{{ route('patient.update',$patient->id) }}" method="post">
                  ...
                  <div data-mdb-input-init class="form-outline mb-4">
                    ...
                    <input type="text" id="form3Example1cg" name="name" class="form-control form-control-lg" placeholder="İsim" required  value="{{$patient->name}}"/>

                  </div>
                  <div data-mdb-input-init class="form-outline mb-4">
                    <label class="form-label" for="form3Example2cg">TC Kimlik No</label>
                    <input type="text" id="form3Example2cg" name="tc" class="form-control form-control-lg" placeholder="TC Kimlik No" required readonly value="{{$patient->tc}}" />

                  </div>
                  <div data-mdb-input-init class="form-outline mb-4">
                    <label class="form-label" for="form3Example3cg">TC Kimlik Seri Numarası</label>
                    <input type="text" id="form3Example3cg" name="serial_key" class="form-control form-control-lg" placeholder="TC Kimlik Seri Numarası" required  readonly value="{{$patient->serial_key}}"  />

                  </div>
                  <div data-mdb-input-init class="form-outline mb-4">
                    <select name="disiase" class="form-control form-control-lg" required value="{{$patient->disiase}}">
                  ...
                  <div class="d-flex justify-content-center">
                    <button type="submit" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body">Kayıt güncelle</button>
                  </div>
                </form>
              </div>
            </div>
